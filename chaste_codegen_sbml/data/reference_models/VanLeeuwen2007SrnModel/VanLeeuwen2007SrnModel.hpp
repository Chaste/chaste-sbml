...
{
/* Serialize information required to construct a VanLeeuwen2007SbmlOdeSystem. */
template<class Archive>
inline void save_construct_data(
    Archive & ar, const VanLeeuwen2007SbmlOdeSystem * t, const unsigned int file_version)
{
    const std::vector<double> state_variables = t->rGetConstStateVariables();
    ar & state_variables;
}
/* De-serialize constructor parameters and intiialise a VanLeeuwen2007SbmlOdeSystem. */
template<class Archive>
inline void load_construct_data(
    Archive & ar, VanLeeuwen2007SbmlOdeSystem * t, const unsigned int file_version)
{
