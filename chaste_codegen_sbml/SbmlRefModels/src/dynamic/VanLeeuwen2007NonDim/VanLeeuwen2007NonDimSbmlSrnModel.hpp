#ifndef VANLEEUWEN2007NONDIMSBMLSRNMODEL_HPP_
#define VANLEEUWEN2007NONDIMSBMLSRNMODEL_HPP_
...
protected:
     ...
     */
    VanLeeuwen2007NonDimSbmlSrnModel(const VanLeeuwen2007NonDimSbmlSrnModel& rModel);
...
public:
     ...
     *
     */
    VanLeeuwen2007NonDimSbmlSrnModel(boost::shared_ptr<AbstractCellCycleModelOdeSolver> pOdeSolver = boost::shared_ptr<AbstractCellCycleModelOdeSolver>());
     ...
     * @return #mpOdeSystem.
     */
    VanLeeuwen2007NonDimSbmlOdeSystem* GetOdeSystem() const;
...
#endif // VANLEEUWEN2007NONDIMSBMLSRNMODEL_HPP_