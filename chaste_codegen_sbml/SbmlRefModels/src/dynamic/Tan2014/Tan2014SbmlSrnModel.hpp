...
protected:
     ...
     */
    Tan2014SbmlSrnModel(const Tan2014SbmlSrnModel& rModel);
...
public:
     ...
     *
     */
    Tan2014SbmlSrnModel(boost::shared_ptr<AbstractCellCycleModelOdeSolver> pOdeSolver = boost::shared_ptr<AbstractCellCycleModelOdeSolver>());
     ...
     * @return #mpOdeSystem.
     */
    Tan2014SbmlOdeSystem* GetOdeSystem() const;
