#ifndef CHEN2000SBMLCELLCYCLEMODEL_HPP_
#define CHEN2000SBMLCELLCYCLEMODEL_HPP_
...
class Chen2000SbmlCellCycleModel : public AbstractSbmlCellCycleModel
{
private:
    friend class boost::serialization::access;
    /**
     * Save / load Chen2000SbmlCellCycleModel archive
     *
...
protected:
     ...
     */
    Chen2000SbmlCellCycleModel(const Chen2000SbmlCellCycleModel& rModel);
...
public:
     ...
     */
    Chen2000SbmlCellCycleModel* CreateCellCycleModel();

    /**
     * @return #mpOdeSystem.
     */
    Chen2000SbmlOdeSystem* GetOdeSystem() const;
...
#endif // CHEN2000SBMLCELLCYCLEMODEL_HPP_